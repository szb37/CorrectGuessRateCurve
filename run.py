...
if True:  # CGR curves of default toy models - reproduces Figure 3
    toy_models.Controllers.run_cgrc_model_family(
...
if True:  # CGR adjusted outcomes of self-blinding microdose trial - reproduces Table 2
...
if True:  # CGR curves of self-blinding microdose trial outcomes - reproduces Figure 4
    cgrc.Controllers.run_cgrc_trial(
        trial_name='sbmd',
        postfix='cgrC_tmp',
