...
data_raw = os.path.abspath(os.path.join(data, '01_raw'))
data_preprocessed = os.path.abspath(os.path.join(data, '02_preprocessed'))
data_trial_data = os.path.abspath(os.path.join(data, '03_trial_data'))
data_trial_stats = os.path.abspath(os.path.join(data, '04_trial_stats'))
data_cgrc_data = os.path.abspath(os.path.join(data, '05_cgrc_data'))
data_cgrc_stats = os.path.abspath(os.path.join(data, '06_cgrc_stats'))
data_summary_tables = os.path.abspath(os.path.join(data, '07_summary_tables'))
